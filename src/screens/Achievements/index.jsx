...
const ReportsScreen = ({ navigation, route, hideOption = false }) => {
  ...
  return (
    <View style={{ flex: 1, paddingLeft: 16, paddingRight: 16, width: "100%" }}>
      ...
      <View>
        <Surface elevation={4} style={{ padding: 16, borderRadius: 10 }}>
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: 'center' }}>
            <MaterialCommunityIcons name="cup-water" size={28} color={colors.primary} />
            <Text variant="headlineLarge" style={{ marginLeft: 8, fontWeight: 'bold', color: colors.primary }}>
              Water
            </Text>
          </View>
          ...
          <View>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: 'space-between' }}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                {waterLevel >= 1 && <MaterialCommunityIcons name="star-circle-outline" size={35} color={colors.primary} />}
                {waterLevel >= 2 && <MaterialCommunityIcons name="trophy-variant-outline" size={35} color={colors.primary} />}
                {waterLevel >= 3 && <MaterialCommunityIcons name="medal-outline" size={35} color={colors.primary} />}
                {waterLevel >= 4 && <MaterialCommunityIcons name="trophy-award" size={35} color={colors.primary} />}
              </View>
            </View>
          </View>
        </Surface>

        <Surface elevation={4} style={{ padding: 16, borderRadius: 10, marginTop: 16 }}>
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: 'center' }}>
          ...
          <View>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: 'space-between' }}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                {workoutLevel >= 1 && <MaterialCommunityIcons name="star-circle-outline" size={35} color={colors.primary} />}
                {workoutLevel >= 2 && <MaterialCommunityIcons name="trophy-variant-outline" size={35} color={colors.primary} />}
                {workoutLevel >= 3 && <MaterialCommunityIcons name="medal-outline" size={35} color={colors.primary} />}
                {workoutLevel >= 4 && <MaterialCommunityIcons name="trophy-award" size={35} color={colors.primary} />}
              </View>
            </View>
          </View>
        </Surface>
          ...
          <View>
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: 'space-between' }}>
              ...
              {weightHistoryResult === 0 ? (
                <Text variant="titleLarge" style={{ color: "#888" }}>
                  Not enough data to show
                </Text>
              ) : (
                <Text variant="titleSmall" style={{ color: "#777", textAlign: 'center' }}>
                  {weightHistoryResult}
                </Text>
              )}
              <View />
